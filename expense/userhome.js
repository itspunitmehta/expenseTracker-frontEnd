...
function deleteExpense(e, expenseid) {
    axios.delete(`http://localhost:8000/user/deleteexpense/${expenseid}`, { headers: {"Authorization" : loginToken} })
    .then((response) => {
...
document.getElementById('rzp-button1').onclick = async function (e) {
    const response  = await axios.get('http://localhost:8000/purchase/premiummembership', { headers: {"Authorization" : loginToken} });
